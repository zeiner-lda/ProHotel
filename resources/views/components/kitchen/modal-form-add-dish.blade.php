<x-layout.app>
    ...
    <div wire:ignore.self class="modal fade" id="form-add-dish" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
          <div class="modal-content bg-white">
            <div class="modal-header">
              <h1 class="modal-title fs-5 text-uppercase">{{ $status ? 'Editar' : 'Adicionar' }} Prato</h1>
              ...
              <form wire:submit.prevent="{{ $status ? 'update' : 'save' }}">
                <div class="gap-1">
                          ...
                          <div class='form-group'>
                            ...
                            <input required wire:model='dishName' type='text' class='form-control rounded' />
                            @error("dishName") <span class='text-danger'>{{ $message }}</span> @enderror
                          </div>
